...
const routes = [
    ...
    createRoute("/hr/applications/:id", withUserAuth(ApplicationsView, ["hr"], {isHR: true, getApplications: (id) => applicationsAPI.getApplicationsByOfferId(id), getProcess: (id) => processAPI.getProcessById(id)})),
